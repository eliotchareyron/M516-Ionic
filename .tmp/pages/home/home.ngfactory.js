...
var _View_HomePage0 = (function (_super) {
    ...
    _View_HomePage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import32.List) && ((11 <= requestNodeIndex) && (requestNodeIndex <= 14)))) {
            return this._List_11_3.context;
        }
        if (((token === import33.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 15)))) {
    ...
    _View_HomePage0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        var currVal_3 = this.context.posts;
...
var _View_HomePage1 = (function (_super) {
    ...
    _View_HomePage1.prototype.createInternal = function (rootSelector) {
        ...
        this._Item_0_4 = new import34.Wrapper_Item(this.parent.parentInjector.get(import36.Form), this.parent.parentInjector.get(import17.Config), new import18.ElementRef(this._el_0), this.renderer, this.parent.parentInjector.get(import37.ItemReorder, null));
    ...
    _View_HomePage1.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        var currVal_0 = import4.interpolate(1, ' id : ', this.context.$implicit.id, ' ');
        if (import4.checkBinding(throwOnChange, this._expr_0, currVal_0)) {
            this.renderer.setText(this._text_3, currVal_0);
            this._expr_0 = currVal_0;
        }
        var currVal_1 = import4.interpolate(1, '  crée le : ', this.context.$implicit.created_at, ' ');
        if (import4.checkBinding(throwOnChange, this._expr_1, currVal_1)) {
            this.renderer.setText(this._text_6, currVal_1);
            this._expr_1 = currVal_1;
        }
        var currVal_2 = import4.interpolate(1, '  latitude  : ', this.context.$implicit.lat, ' ');
        if (import4.checkBinding(throwOnChange, this._expr_2, currVal_2)) {
            this.renderer.setText(this._text_9, currVal_2);
            this._expr_2 = currVal_2;
        }
        var currVal_3 = import4.interpolate(1, '  longitude : ', this.context.$implicit.lng, ' ');
